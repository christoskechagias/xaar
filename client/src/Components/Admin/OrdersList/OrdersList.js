								...
								<TableRow>
									<TableCell>
										...
										>
											...
											<option value="lowestTotalPrice">
												Lowest Total Price
											</option>
											<option value="highestTotalPrice">
												Highest Total Price
											</option>
							...
							<TableBody>
								{rows
									.sort((a, b) => {
										...
										} else if (typeOfSort == 'lowestTotalPrice') {
											if (a.totalPrice > b.totalPrice) {
												return 1;
											} else {
												return -1;
											}
										} else if (typeOfSort == 'highestTotalPrice') {
											if (a.totalPrice < b.totalPrice) {
												return 1;
											} else {
												return -1;
...
function Row(props) {
	...
	const deliveryStatusHandler = (e) => {
		setStatus(e.target.value);
		dispatch(updateOrderAction(_id, e.target.value));
	};
	...
	return (
		<Fragment>
			<TableRow>
				...
				<TableCell align="center">
					<select value={status} onChange={deliveryStatusHandler}>
